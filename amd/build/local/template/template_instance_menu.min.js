define("local_coursegen/local/template/template_instance_menu",["exports","core/templates","jquery"],(function(_exports,_templates,_jquery){function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.openInstanceMenu=_exports.closeInstanceMenu=void 0,_templates=_interopRequireDefault(_templates),_jquery=_interopRequireDefault(_jquery);_exports.openInstanceMenu=async _ref=>{let{triggerEl:triggerEl,options:options}=_ref;const menuEl=triggerEl.closest(".dropdown").querySelector(".dropdown-menu"),rendered=await _templates.default.render("local_coursegen/template_instance_menu",{hasoptions:options.length>0,options:options});_templates.default.replaceNodeContents(menuEl,rendered,""),(0,_jquery.default)(triggerEl).dropdown("toggle")};_exports.closeInstanceMenu=triggerEl=>{(0,_jquery.default)(triggerEl).dropdown("hide")}}));

//# sourceMappingURL=template_instance_menu.min.js.map