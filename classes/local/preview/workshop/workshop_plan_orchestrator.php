...
trait workshop_plan_orchestrator {
    ...
    /**
     * Ported from workshop_user_plan::__construct(): polish data, set default values if not done explicitly.
     */
    ...
    /**
     * Ported from workshop_user_plan::__construct(): add phase switching actions.
     */
