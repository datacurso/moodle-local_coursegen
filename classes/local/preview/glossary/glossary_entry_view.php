...
/**
 * mod_glossary's per-entry rendering, built the same way view.php builds it: the
...
trait glossary_entry_view {
     ...
     *
     * The dictionary format is the only one built here; a glossary set to another
