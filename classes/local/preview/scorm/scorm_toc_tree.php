...
trait scorm_toc_tree {
    /**
     * Copied from scorm_format_toc_for_treeview(), with the player's links made to the preview.
     *
     * @param array $scoes
    ...
    protected function scorm_format_toc_for_treeview(array $scoes, array $usertracks, int $toclink = TOCJSLINK,
        ...
        if (!empty($scoes)) {
            foreach ($scoes as $sco) {
                ...
                // $result->prerequisites already defaults to true, and
                // mod_scorm's own check for whether it should be set here
