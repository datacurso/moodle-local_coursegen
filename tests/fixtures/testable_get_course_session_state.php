...
/**
 * Testable get_course_session_state that lets tests inject a mock API service
 * through the protected factory seam (late static binding).
 *
 * Loading this fixture pulls in lib/externallib.php (through
 * get_course_session_state), so any test using it must run in an isolated
 * process.
 *
 ...
 */
class testable_get_course_session_state extends \local_coursegen\external\get_course_session_state {
