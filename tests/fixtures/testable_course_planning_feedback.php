...
/**
 * Testable course_planning_feedback that lets tests inject a mock API service
 * through the protected factory seam (late static binding).
 *
 * Loading this fixture pulls in lib/externallib.php (through
 * course_planning_feedback), so any test using it must run in an isolated
 * process.
 *
 ...
 */
class testable_course_planning_feedback extends \local_coursegen\external\course_planning_feedback {
