...
/**
 * Testable get_course_settings that lets tests inject a mock API service
 * through the protected factory seam (late static binding).
 *
 * Loading this fixture pulls in lib/externallib.php (through
 * get_course_settings), so any test using it must run in an isolated process.
 *
 * @package    local_coursegen
 * @copyright  2026 Wilber Narvaez <https://datacurso.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class testable_get_course_settings extends \local_coursegen\external\get_course_settings {
