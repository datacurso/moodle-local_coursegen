...
/**
 * Testable course_planning_service that lets tests inject a mock API service
 ...
 */
class testable_course_planning_service extends \local_coursegen\local\service\course_planning_service {
