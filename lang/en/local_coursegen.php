...
$string['setting_feature_toggles_heading'] = 'Feature toggles';
$string['setting_feature_toggles_heading_desc'] = 'Enable or disable individual plugin features. These settings act as master switches — when a feature is disabled here, it is hidden for all users regardless of their role or capabilities.';
