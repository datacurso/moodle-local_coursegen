...
$string['help_part_maximages_help'] = 'Maximum number of images that the AI will generate for this specific part of the activity (between 0 and 5). If you disable the part, no images will be created for it.';
