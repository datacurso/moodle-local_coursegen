...
$string['coursegen_template_service_url'] = 'Coursegen template service URL';
$string['coursegen_template_service_url_desc'] = 'Base URL for the coursegen-template test/dev service used by http_template_ai_service. Leave empty to use the default (http://coursegen-template:3000).';
...
$string['error_template_service_response'] = 'The coursegen-template service returned an invalid response: {$a}';
