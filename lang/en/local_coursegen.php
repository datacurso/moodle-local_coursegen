...
$string['courseai_template_based_on'] = 'Based on: {$a}';
$string['courseai_template_generate_unavailable'] = 'Course generation from a template is not available yet';
...
$string['template_section_custom'] = 'Allow AI modification';
...
$string['template_section_custom_tip'] = 'The teacher may modify this section with AI: each activity follows its own action and the teacher can add new AI-generated activities based on their own instructions';
