...
$string['error_missing_mold_package_info'] = 'The AI response does not include the filled H5P content (content_json/h5p_json) required to rebuild this activity from its template. Please try again.';
...
$string['error_mold_package_missing'] = 'The template H5P activity (course module {$a}) does not carry a package to rebuild this activity from. Please check the template and try again.';
$string['error_mold_source_not_found'] = 'The template H5P activity the AI response points at (course module {$a}) does not exist. Please check the template and try again.';
