...
$string['template_kind_defaults_title'] = 'Default behavior per kind of component';
$string['template_kind_defaults_desc'] = 'Set one behavior for every banner, page, forum, etc. at once — you only need to review the individual exception below.';
$string['template_configure_sections'] = 'Review the structure';
$string['template_configure_sections_desc'] = 'Only change an individual activity if it needs to differ from its kind\'s default above';
...
$string['template_naming_custom_help'] = 'Use {N} for number and {name} for original name';
