...
$string['courseai_sessions_col_created'] = 'Created at';
$string['courseai_sessions_col_name'] = 'Name';
$string['courseai_sessions_col_status'] = 'Status';
$string['courseai_sessions_empty'] = 'You have no courses yet.';
$string['courseai_sessions_filter_all'] = 'Any status';
$string['courseai_sessions_newbtn'] = 'New course';
$string['courseai_sessions_noresults'] = 'No courses match your search.';
$string['courseai_sessions_search'] = 'Search courses...';
...
$string['courseai_sidebar_recent'] = 'Recent courses';
$string['courseai_sidebar_toggle'] = 'Toggle sidebar';
$string['courseai_sidebar_open'] = 'Open sidebar';
$string['courseai_sidebar_close'] = 'Close sidebar';
...
$string['coursegen:managetemplates'] = 'Manage course templates';
...
// The starting point: chosen on its own screen, then named in the bar above the workspace.
$string['courseai_start_title'] = 'How do you want to start?';
$string['courseai_start_subtitle'] = 'Pick a starting point. You can change it before generating.';
$string['courseai_start_free_desc'] = 'Describe the course and the AI proposes the full set of sections and activities. You review the plan before anything exists in Moodle.';
$string['courseai_start_free_for'] = 'Ideal if you do not have a structure yet';
$string['courseai_start_template'] = 'From a template';
$string['courseai_start_template_desc'] = 'Start from the structure of an institutional template. The AI writes only the marked activities; the rest is copied as is.';
$string['courseai_start_template_for'] = 'Ideal if your institution defines the structure';
$string['courseai_start_mostused'] = 'Most used';
...
$string['courseai_start_change'] = 'Change starting point';
...
$string['courseai_template_pick_hint_title'] = 'First choose the template';
$string['courseai_template_pick_hint'] = 'Its structure will appear on the right and you can describe how to adapt it.';
$string['courseai_template_structure_empty_title'] = 'Here the template\'s structure appears';
$string['courseai_template_structure_empty'] = 'Choose a template on the left to see it. Nothing is created in Moodle until you approve the plan.';
...
$string['courseai_preview_empty'] = 'This activity has no content to preview yet.';
$string['courseai_preview_activity'] = 'Preview this activity';
...
$string['courseai_template_log_approved'] = 'You approved the plan.';
$string['courseai_template_log_completed'] = 'The course is ready.';
$string['courseai_template_log_generating'] = 'Writing the content of each activity.';
$string['courseai_template_log_plan_ready'] = 'I finished planning. Review it and approve it to write the course.';
$string['courseai_template_log_planned'] = 'Planned the content of each activity';
$string['courseai_template_log_planning'] = 'Reading the template and the material you attached.';
$string['courseai_template_review_summary'] = '{$a} activities are planned and ready to be written.';
$string['courseai_template_plan_empty'] = 'This activity has no content to plan: its mould carries no markers.';
$string['courseai_template_review_adjust'] = 'Request changes';
$string['courseai_template_review_approve'] = 'Approve and generate';
$string['courseai_template_review_hint'] = 'The template defines the structure, so it cannot be changed here. You can ask for the content to be planned again.';
$string['courseai_template_review_placeholder'] = 'What would you like to change?';
$string['courseai_template_review_title'] = 'Review the plan before generating';
$string['courseai_template_stage_planning'] = 'Planning the content of each activity…';
...
$string['courseai_template_stage_connecting'] = 'Starting the generation…';
$string['courseai_template_stage_saving'] = 'Saving the generated content…';
$string['courseai_template_stage_section_images'] = 'Preparing the section images…';
$string['courseai_template_stage_style'] = 'Preparing the course style…';
$string['courseai_template_instance_badge_tip'] = 'An AI-generated activity, molded on one of the template\'s model activities, will be created here for your course.';
$string['courseai_template_limits_used'] = '{$a->used} of {$a->max} sections used';
$string['courseai_template_limits_remaining'] = '{$a} sections remaining';
$string['courseai_template_limits_nolimit'] = 'No section limit';
$string['courseai_template_add_section'] = 'Add section';
$string['courseai_template_add_activity'] = 'Add activity';
$string['courseai_template_modal_title'] = 'Add an activity or resource';
$string['courseai_template_modal_note'] = 'This template limits which activities you can add.';
$string['courseai_template_modal_search'] = 'Search';
$string['courseai_template_modal_empty'] = 'No activity types are allowed for this template yet.';
...
$string['template_wizard_title'] = 'Course templates';
$string['template_wizard_subtitle'] = 'Configure how AI should generate courses based on an existing one';
$string['template_step_list'] = 'List';
$string['template_step_course'] = 'Course';
$string['template_step_preview'] = 'Preview';
$string['template_step_sections'] = 'Sections';
$string['template_step_limits'] = 'Limits';
$string['template_step_save'] = 'Save';
$string['template_create'] = 'Create template';
$string['template_edit'] = 'Edit template';
$string['template_change_course'] = 'Change selection';
...
$string['template_select_course'] = 'Select base course';
$string['template_select_course_desc'] = 'Choose the course you want to use as a template';
$string['template_search_course'] = 'Search by name or code...';
$string['template_search_placeholder_full'] = 'Search courses';
...
$string['template_description_placeholder'] = 'Describe what this template is for...';
$string['template_configure_sections'] = 'Course sections';
$string['template_configure_sections_desc'] = 'Sections and activities of the selected course';
$string['template_section_aimodify'] = 'Allow AI modification';
$string['template_section_keep'] = 'Keep intact';
$string['template_section_exclude'] = 'Do not include';
$string['template_section_keep_desc'] = 'This section will be copied exactly as-is to the new course. No configuration needed.';
$string['template_section_exclude_desc'] = 'This section will not appear in courses generated with this template.';
$string['template_activity_template'] = 'Use as template';
$string['template_activity_keep'] = 'Keep intact';
$string['template_activity_reference'] = 'Reference only';
$string['template_activity_exclude'] = 'Do not include';
$string['template_activity_ref_original'] = 'Use original as reference';
$string['template_activity_ref_pass'] = 'Pass as reference to AI';
$string['template_activity_no_prompt'] = 'No prompt — AI will use the structure as reference';
$string['template_activity_prompt_placeholder'] = 'Describe how AI should modify this {$a->modtype} ("{$a->activityname}")...';
$string['template_activity_template_tip'] = 'This activity is a structural mold: it never appears in generated courses. Its placeholders and structure are used to generate other activities marked "Allow AI modification".';
$string['template_activity_keep_tip'] = 'The activity is copied exactly as is; the teacher cannot change it';
$string['template_activity_reference_tip'] = 'Not copied to the new course; AI only uses it as a reference for tone and depth';
$string['template_activity_exclude_tip'] = 'The activity is not included in courses created from this template';
$string['template_activity_template_badge'] = 'Template';
$string['template_activity_template_tag'] = 'Template · {$a}';
$string['template_activity_scope'] = 'Template scope';
$string['template_activity_scope_course'] = 'Whole course';
...
$string['template_instance_scope_whole_course'] = 'whole course';
$string['template_instance_scope_same_section'] = 'this section';
$string['template_instance_scope_unavailable'] = 'Its scope is "this section only" and it lives in a different section.';
$string['template_instance_unmark_confirm_title'] = 'Remove this template?';
$string['template_instance_unmark_confirm_body'] = 'Changing this activity away from "Use as template" will also remove the {$a} activity/activities already added from it.';
$string['template_allow_add_sections'] = 'Allow the teacher to add sections';
$string['template_allow_add_sections_help'] = 'When checked, the teacher creating a course from this template may add extra sections on top of the sections the template already provides.';
$string['template_extra_sections'] = 'Number of sections the teacher can add';
$string['template_extra_sections_help'] = 'How many extra sections the teacher may add beyond the template\'s own sections. The sections the template already contains are never counted against this number.';
$string['template_section_aimodify_tip'] = 'The teacher may modify this section with AI: each activity follows its own action and the teacher can add new AI-generated activities based on their own instructions';
$string['template_section_keep_tip'] = 'The section is imported as is; the teacher cannot change it';
$string['template_section_no_activities'] = 'This section has no activities';
$string['template_section_exclude_tip'] = 'The section is not included in courses created from this template';
$string['template_activity_ref_info'] = 'AI will use this activity as reference to understand tone and depth. It will not be copied to the new course.';
$string['template_bulk_action'] = 'Apply to selected…';
$string['template_quick_actions'] = 'Quick actions';
$string['template_bulk_keep'] = 'Keep all intact';
...
$string['template_limits_desc'] = 'Control how many extra sections the teacher may add on top of the template\'s own sections';
$string['template_max_sections'] = 'Maximum sections';
$string['template_max_sections_help'] = 'The original course has {$a} sections. Sets how many sections (modules) a course generated from this template may have in total. If the actual content needs fewer sections, the AI merges them to fit; if it needs more, extra sections are added up to this limit.';
$string['template_max_sections_info'] = 'The original course has {$a} sections';
$string['template_sections_count'] = 'sections';
$string['template_no_limit'] = 'No limit';
$string['template_no_limit_help'] = 'When checked, the generated course may have as many sections as its content actually needs, ignoring the Maximum sections field above. Use this when the final section count genuinely isn\'t known ahead of time.';
$string['template_max_sections_fewer'] = 'AI will merge extra sections to fit the limit.';
$string['template_max_sections_more'] = 'AI may add additional sections if needed.';
$string['template_max_sections_same'] = 'Same number of sections as the original course.';
$string['template_allowed_types'] = 'Allowed activity types';
$string['template_allowed_types_desc'] = 'What activity types can AI create in the new course?';
$string['template_allowed_types_help'] = 'A professor building a course from this template may add new activities of any type selected here, on top of what the template itself already contains. Only types the AI content service can actually generate are offered. A type not selected here cannot be added as a new activity in courses generated from this template — existing activities copied from the base course are not affected by this setting.';
$string['template_allowed_types_none'] = 'No activity types selected';
$string['template_select_all'] = 'Select all';
$string['template_select_all_tooltip'] = 'Selects every AI-supported activity type.';
$string['template_select_none'] = 'Select none';
$string['template_select_none_tooltip'] = 'Clears every currently selected activity type.';
$string['template_deselect_all'] = 'Deselect all';
$string['template_naming_pattern'] = 'Section naming pattern';
$string['template_naming_pattern_desc'] = 'How should sections be named in the new course?';
$string['template_naming_pattern_help'] = 'How each generated section\'s name is built from its position and the original section\'s own name. Use {N} for the section\'s number and {nombre} for the original section\'s name — for example "Unidad {N} — {nombre}" turns a section originally called "Fundamentos" into "Unidad 1 — Fundamentos".';
$string['template_naming_name_only'] = 'Name only (no numbering)';
$string['template_naming_custom'] = 'Custom...';
$string['template_naming_custom_help'] = 'Use {N} for the section\'s number and {nombre} for the original section\'s name.';
$string['template_naming_start'] = 'Number from:';
$string['template_naming_start_help'] = 'The number given to the very first generated section. Choose 1 to start counting from "Unidad 1", or 0 to start from "Unidad 0".';
$string['template_naming_preview'] = 'Preview:';
$string['template_picker_category'] = 'Category';
$string['template_picker_category_help'] = 'Narrows the course list below to one category. The number next to each category shows how many courses it contains.';
$string['template_picker_course'] = 'Course';
$string['template_picker_course_help'] = 'The actual course whose structure (sections and activities) becomes this template. Its content is never changed by creating a template from it — a template only reads and copies from this course.';
$string['template_summary_title'] = 'Template summary';
$string['template_table_type'] = 'Type';
$string['template_with_selected_activities'] = 'With selected activities…';
$string['template_summary_subtitle'] = 'Review everything before saving';
$string['template_summary_name'] = 'Name';
$string['template_summary_base_course'] = 'Base course';
$string['template_summary_max_sections'] = 'Max sections';
$string['template_summary_allowed_types'] = 'Allowed types';
$string['template_summary_naming'] = 'Section naming';
$string['template_summary_config'] = 'Configuration summary';
$string['template_summary_modifiable'] = 'modifiable';
$string['template_summary_intact'] = 'intact';
$string['template_summary_ref_only'] = 'reference only';
$string['template_summary_excluded'] = 'excluded';
$string['template_summary_as_ref'] = 'passed as ref';
$string['template_summary_no_prompt_warn'] = '{$a} activity(ies) marked as "Modify" without a prompt. AI will use the structure as reference.';
$string['template_save'] = 'Save template';
$string['template_saved'] = 'Template "{$a}" saved successfully';
$string['template_back_to_list'] = 'Back to list';
$string['template_keep_editing'] = 'Keep editing';
...
$string['template_exit'] = 'Exit';
$string['template_back'] = 'Back';
$string['template_next'] = 'Next';
$string['template_activities'] = 'activities';
$string['template_activities_count'] = '{$a} activities';
$string['template_present'] = 'present';
$string['template_of'] = 'of';
$string['template_no_courses'] = 'No courses found';
$string['template_select_course_first'] = 'Please select a course first';
