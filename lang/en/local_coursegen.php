...
$string['courseai_syllabus_upload_success'] = 'Syllabus uploaded successfully';
...
$string['coursecreated_partial'] = 'Some activities were skipped due to creation errors.';
...
$string['error_download_failed'] = 'The generated file could not be downloaded from the AI service.';
...
$string['error_provider_unavailable'] = 'The DataCurso AI provider client is not available.';
...
$string['event_generation_denied'] = 'AI generation denied';
...
$string['event_package_download_skipped'] = 'AI generated package skipped';
...
$string['privacy:metadata:datacurso_course_service:instructions'] = 'The instructions or system instruction content sent with the generation request.';
$string['privacy:metadata:datacurso_course_service:lang'] = 'The language requested for the generated content.';
$string['privacy:metadata:datacurso_course_service:prompt'] = 'The free-form prompt written by the user to describe the course or activity.';
$string['privacy:metadata:datacurso_course_service:site_id'] = 'A hash identifying the Moodle site making the request.';
$string['privacy:metadata:datacurso_course_service:site_url'] = 'The URL of the Moodle site making the request.';
$string['privacy:metadata:datacurso_course_service:syllabus_file'] = 'The syllabus file uploaded for course planning.';
$string['privacy:metadata:datacurso_course_service:timezone'] = 'The timezone of the user making the request.';
$string['privacy:metadata:datacurso_course_service:userid'] = 'The ID of the user making the request.';
$string['privacy:metadata:datacurso_course_service:with_images'] = 'Whether image generation was requested.';
...
$string['privacy:metadata:local_coursegen_course_sessions:coursedata'] = 'The stored planning data, including the user\'s free-form prompt and options.';
