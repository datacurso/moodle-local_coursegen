...
$string['coursegen:generateactivityimages'] = 'Generate images with AI in activities';
$string['coursegen:generatecourseimages'] = 'Generate images with AI in courses';
...
$string['error_activity_ai_disabled'] = 'AI activity creation is currently disabled by the site administrator.';
$string['error_activity_image_generation_denied'] = 'You do not have permission to generate images for activities. Contact your site administrator.';
$string['error_context_type_required'] = 'Please select a context type to continue (Syllabus or Custom prompt).';
$string['error_course_ai_disabled'] = 'AI course creation is currently disabled by the site administrator.';
$string['error_course_image_generation_denied'] = 'You do not have permission to generate images for courses. Contact your site administrator.';
...
$string['send'] = 'Send';
$string['setting_activity_ai_heading'] = 'Activity AI';
$string['setting_activity_ai_heading_desc'] = 'Settings for the AI activity and resource creator inside courses.';
$string['setting_course_ai_heading'] = 'Course AI';
$string['setting_course_ai_heading_desc'] = 'Settings for the AI course creator and its associated features.';
$string['setting_enable_activity_ai'] = 'Enable AI activity creation';
$string['setting_enable_activity_ai_desc'] = 'When enabled, users with the appropriate capability will see the "Add activity with AI" button inside courses. When disabled, the button is hidden for all users regardless of their permissions.';
$string['setting_enable_activity_image_generation'] = 'Enable image generation for activities';
$string['setting_enable_activity_image_generation_desc'] = 'When enabled, users with the <code>local/coursegen:generateactivityimages</code> capability will see the image generation option in the AI activity creation modal. When disabled, the option is hidden for all users regardless of their permissions.';
$string['setting_enable_course_ai'] = 'Enable AI course creation';
$string['setting_enable_course_ai_desc'] = 'When enabled, users with the appropriate capability will see the "Create with AI" button on the new course form. When disabled, the button is hidden for all users regardless of their permissions.';
$string['setting_enable_course_image_generation'] = 'Enable image generation for courses';
$string['setting_enable_course_image_generation_desc'] = 'When enabled, users with the <code>local/coursegen:generatecourseimages</code> capability will see the image generation option on the course creation form. When disabled, the option is hidden for all users regardless of their permissions.';
$string['setting_enable_empty_course_ai'] = 'Enable AI generation for empty courses';
$string['setting_enable_empty_course_ai_desc'] = 'When enabled, the "Create with AI" button will also appear on the edit form of existing courses that have no content (only the default Announcements forum). This allows populating empty course shells with AI-generated content. When disabled, the AI button only appears when creating a new course.';
