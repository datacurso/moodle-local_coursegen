...
$string['error_starting_template_planning'] = 'There was an error starting the template planning. Please try again';
$string['error_template_result_timeout'] = 'Timed out waiting for the template planning result. Please try again';
...
$string['template_configure_sections'] = 'Review the structure';
$string['template_configure_sections_desc'] = 'Only change an individual activity if it needs to differ from its type\'s default above';
$string['template_section_custom'] = 'Customised';
...
$string['template_activity_modify'] = 'Modify with AI';
...
$string['template_activity_modify_tip'] = 'AI will generate new content based on this activity';
$string['template_activity_keep_tip'] = 'This activity will be copied exactly as-is';
$string['template_activity_reference_tip'] = 'AI will use this as reference for tone and depth — not copied';
$string['template_activity_exclude_tip'] = 'This activity will not appear in generated courses';
$string['template_section_custom_tip'] = 'Configure each activity individually';
$string['template_section_keep_tip'] = 'Copy this entire section exactly as-is to the new course';
$string['template_section_exclude_tip'] = 'This section will not appear in generated courses';
...
$string['template_general_hdr'] = 'General instruction & reference files';
$string['template_general_desc'] = 'Optional context sent to the AI once per generated course, in addition to each section/activity\'s own configuration.';
$string['template_general_instruction'] = 'General instruction';
$string['template_general_instruction_help'] = 'A free-text instruction applied to the whole course (tone, audience, general constraints, etc.), sent to the AI alongside the template export.';
$string['template_general_files'] = 'General reference files';
$string['template_general_files_help'] = 'Optional files (documents, images, etc.) uploaded once for the whole template, sent to the AI as extra context for every course generated from it.';
...
$string['testcoursegen_title'] = 'Test: create course from .mbz + existing course';
$string['testcoursegen_desc'] = 'Exports the structure of course #{$a}, reconciles it with the real content extracted from the test .mbz backup, and creates a course from the unified result — without calling the real AI backend.';
$string['testcoursegen_sourcecourse'] = 'Source course ID';
$string['testcoursegen_button'] = 'Create test course';
$string['testcoursegen_success'] = 'Course {$a} created successfully.';
$string['testcoursegen_template_title'] = 'Test: create course from real course-template AI planning';
$string['testcoursegen_template_desc'] = 'Builds a throwaway template from course #{$a}, keeping every existing activity as-is except the one targeted below (marked "modify"), sends it to the real course-template AI backend in a single request, and creates a course from its result.';
$string['testcoursegen_template_targetcmid'] = 'Target activity (course-module id)';
$string['testcoursegen_template_targetprompt'] = 'Prompt for the target activity';
$string['testcoursegen_template_button'] = 'Create course from single-activity template test';
$string['testcoursegen_activitytemplate_title'] = 'Test: create course from an activity template (mold)';
$string['testcoursegen_activitytemplate_desc'] = 'Builds a throwaway template from course #{$a}: the mold activity below never regenerates itself and never appears in the resulting course - instead, its placeholder/repeat-marker structure drives the generation of the real target activity below, from the syllabus text. Every other activity is kept as-is.';
$string['testcoursegen_activitytemplate_templatecmid'] = 'Template (mold) activity (course-module id)';
$string['testcoursegen_activitytemplate_targetcmid'] = 'Target activity to generate (course-module id)';
$string['testcoursegen_activitytemplate_syllabus'] = 'Syllabus / source material for the target activity';
$string['testcoursegen_activitytemplate_button'] = 'Create course from activity template test';
