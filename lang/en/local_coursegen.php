...
$string['template_type_defaults_title'] = 'Default behavior per activity type';
$string['template_type_defaults_desc'] = 'Set one behavior for every banner, page, forum, etc. at once — you only need to review the individual exception below.';
...
$string['template_activity_prompt_placeholder'] = 'Describe how AI should modify this activity...';
...
$string['template_allowed_types_desc'] = 'What activity types can AI use in the new course?';
$string['template_allowed_type'] = 'Allow {$a} in generated courses';
$string['template_allowed_type_help'] = 'When checked, a professor building a course from this template may add new {$a} activities on top of what the template itself already contains. When unchecked, {$a} cannot be added as a new activity in courses generated from this template — existing ones copied from the base course are not affected by this setting.';
...
$string['template_type_default_label'] = 'Banners';
$string['template_type_default_label_help'] = 'The visual header shown at the top of a module (and, on courses using the grid course format, also its picture tile). Defaults to Modify so it gets regenerated for the new course, following the same design already used across the rest of it.';
$string['template_type_default_page'] = 'Informational pages';
$string['template_type_default_page_help'] = 'Pages such as the course overview, general rules, or a module\'s own explanatory content. Defaults to Modify so their text reflects the new course\'s own subject.';
$string['template_type_default_forum'] = 'Discussion forums';
$string['template_type_default_forum_help'] = 'Discussion spaces such as the teacher\'s own forum or a module\'s discussion activity. Defaults to Keep, since a forum\'s structure and prompt rarely need to change between courses built from the same template.';
$string['template_type_default_resource'] = 'File attachments';
$string['template_type_default_resource_help'] = 'Uploaded files such as the syllabus document. These can never be regenerated by AI, so only Keep (reuse the file as-is) or Reference (let the AI read its content as background, without adding it as a file) are real options here — AI-generated text cannot become a real uploaded file.';
$string['template_type_default_assign'] = 'Graded activities';
$string['template_type_default_assign_help'] = 'Assignments, exams and other graded tasks. Defaults to Modify so instructions are written for the new course\'s own subject, while keeping the same grading setup.';
$string['template_type_default_feedback'] = 'Closing survey';
$string['template_type_default_feedback_help'] = 'The course\'s own opinion survey, usually placed at the end of a module or the whole course. Defaults to Keep, since its questions rarely change from course to course.';
$string['template_type_default_lesson'] = 'Lesson content';
$string['template_type_default_lesson_help'] = 'Multi-page lesson activities, typically a module\'s main content vehicle. Defaults to Keep for now, while AI support for regenerating this activity type is still being built.';
$string['template_type_default_generic'] = 'Other activity types';
$string['template_type_default_generic_help'] = 'This course contains an activity type not specifically recognised by this template tool. It cannot be regenerated by AI today, so only Keep, Reference or Exclude are offered.';
