...
$string['coursegen:generateactivityimages'] = 'Generar imágenes con IA en actividades';
$string['coursegen:generatecourseimages'] = 'Generar imágenes con IA en cursos';
...
$string['devsettings'] = 'Configuración de desarrollo';
...
$string['error_activity_ai_disabled'] = 'La creación de actividades con IA está desactivada por el administrador del sitio.';
$string['error_activity_image_generation_denied'] = 'No tiene permiso para generar imágenes en actividades. Contacte al administrador del sitio.';
$string['error_context_type_required'] = 'Selecciona un tipo de contexto para continuar (Silabo o Prompt personalizado).';
$string['error_course_ai_disabled'] = 'La creación de cursos con IA está desactivada por el administrador del sitio.';
$string['error_course_image_generation_denied'] = 'No tiene permiso para generar imágenes en cursos. Contacte al administrador del sitio.';
...
$string['send'] = 'Enviar';
$string['setting_activity_ai_heading'] = 'IA para actividades';
$string['setting_activity_ai_heading_desc'] = 'Configuración del creador de actividades y recursos con IA dentro de los cursos.';
$string['setting_course_ai_heading'] = 'IA para cursos';
$string['setting_course_ai_heading_desc'] = 'Configuración del creador de cursos con IA y sus funcionalidades asociadas.';
$string['setting_enable_activity_ai'] = 'Activar creación de actividades con IA';
$string['setting_enable_activity_ai_desc'] = 'Cuando está activado, los usuarios con el permiso correspondiente verán el botón "Añadir actividad con IA" dentro de los cursos. Cuando está desactivado, el botón se oculta para todos los usuarios sin importar sus permisos.';
$string['setting_enable_activity_image_generation'] = 'Activar generación de imágenes para actividades';
$string['setting_enable_activity_image_generation_desc'] = 'Cuando está activado, los usuarios con el permiso <code>local/coursegen:generateactivityimages</code> verán la opción de generar imágenes en el modal de creación de actividades con IA. Cuando está desactivado, la opción se oculta para todos los usuarios sin importar sus permisos.';
$string['setting_enable_course_ai'] = 'Activar creación de cursos con IA';
$string['setting_enable_course_ai_desc'] = 'Cuando está activado, los usuarios con el permiso correspondiente verán el botón "Crear con IA" en el formulario de creación de cursos. Cuando está desactivado, el botón se oculta para todos los usuarios sin importar sus permisos.';
$string['setting_enable_course_image_generation'] = 'Activar generación de imágenes para cursos';
$string['setting_enable_course_image_generation_desc'] = 'Cuando está activado, los usuarios con el permiso <code>local/coursegen:generatecourseimages</code> verán la opción de generar imágenes en el formulario de creación de cursos. Cuando está desactivado, la opción se oculta para todos los usuarios sin importar sus permisos.';
$string['setting_enable_empty_course_ai'] = 'Activar generación con IA para cursos vacíos';
$string['setting_enable_empty_course_ai_desc'] = 'Cuando está activado, el botón "Crear con IA" también aparecerá en el formulario de edición de cursos existentes que no tengan contenido (solo el foro de Novedades por defecto). Esto permite poblar cursos vacíos con contenido generado por IA. Cuando está desactivado, el botón de IA solo aparece al crear un curso nuevo.';
