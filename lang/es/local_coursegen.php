...
$string['mode_disabled_desc'] = 'No generar imágenes automáticamente.';
$string['mode_auto'] = 'Automático';
$string['mode_auto_desc'] = 'Generar imágenes automáticamente usando prompts por defecto.';
$string['mode_manual'] = 'Manual';
$string['mode_manual_desc'] = 'Generar imágenes usando prompts personalizados por tipo de actividad.';
