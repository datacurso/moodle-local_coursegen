...
$string['wizard_init_success'] = 'Sesión de creación iniciada correctamente';
$string['wizard_syllabus_upload_success'] = 'Sílabo subido correctamente';
...
// Strings de interfaz del wizard.
...
$string['wizard_context_subtitle'] = 'Describe el curso y, si quieres, adjunta el sílabo o aplica directrices institucionales.';
$string['wizard_prompt_placeholder'] = 'Ejemplo: Crea un curso introductorio de Python para primer ciclo de ingeniería, 8 semanas, con énfasis en pensamiento computacional y ejercicios prácticos cada semana...';
$string['wizard_compact_prompt_placeholder'] = 'Ejemplo: En la sección 2 realiza 3 actividades';
$string['wizard_prompt_arialabel'] = 'Descripción del curso';
$string['wizard_chip_remove_syllabus'] = 'Quitar sílabo';
$string['wizard_chip_view_guideline'] = 'Ver directriz';
$string['wizard_chip_remove_guideline'] = 'Quitar directriz';
$string['wizard_btn_syllabus'] = 'Sílabo';
$string['wizard_btn_syllabus_title'] = 'Adjuntar sílabo (PDF, DOCX, TXT)';
$string['wizard_btn_guidelines'] = 'Directrices';
$string['wizard_btn_guidelines_title'] = 'Directrices institucionales';
$string['wizard_guidelines_dialog_label'] = 'Directrices institucionales';
$string['wizard_guidelines_search_placeholder'] = 'Buscar directriz...';
$string['wizard_guidelines_note_one'] = 'Solo puedes aplicar una directriz por curso.';
$string['wizard_guidelines_list_label'] = 'Lista de directrices';
$string['wizard_lang_title'] = 'Idioma del curso';
$string['wizard_lang_arialabel'] = 'Idioma';
$string['wizard_images_title'] = 'Incluir sugerencias de imágenes en el curso';
$string['wizard_images_label'] = 'Imágenes';
$string['wizard_images_arialabel'] = 'Incluir imágenes';
$string['wizard_hint_enter'] = '↵ para generar';
$string['wizard_btn_generate'] = 'Generar';
$string['wizard_form_tip'] = 'Tip: sé específico con tema, nivel, duración y objetivos para una mejor planificación.';
...
$string['wizard_btn_adjust'] = 'Ajustar';
$string['wizard_btn_approve'] = 'Aprobar';
$string['wizard_adjust_placeholder'] = 'Indicá qué querés ajustar en la planificación...';
...
$string['wizard_btn_pause'] = 'Pausar';
$string['wizard_modal_close'] = 'Cerrar';
$string['wizard_modal_subtitle_text'] = 'Contenido completo que se enviará a la IA como contexto.';
$string['wizard_modal_fullcontext'] = 'Contenido completo que se enviará a la IA como contexto.';
$string['wizard_no_results'] = 'Sin resultados';
$string['wizard_category_general'] = 'General';
$string['wizard_state_planning'] = 'Planificando...';
$string['wizard_state_starting'] = 'Iniciando...';
$string['wizard_state_structuring'] = 'Diseñando la estructura del curso';
$string['wizard_state_completed'] = 'COMPLETADO';
$string['wizard_state_error'] = 'ERROR';
$string['wizard_plan_counter'] = 'SECCION {sections} · {activities} ACTIVIDADES';
$string['wizard_plan_adding'] = 'Anadiendo: {name}';
...
$string['wizard_plan_review_hint_detailed'] = 'Aproba el plan para comenzar a generar el contenido del curso.';
$string['wizard_plan_detailed_done_title'] = 'Plan detallado listo';
$string['wizard_plan_detailed_done_subtitle'] = '{activities} actividades planificadas.';
$string['wizard_plan_detailed_markdown_title'] = 'Plan detallado generado';
$string['wizard_plan_detailed_markdown_subtitle'] = 'Revisa el contenido y aproba para iniciar la generacion.';
$string['wizard_generating_details'] = 'Generando detalles...';
$string['wizard_generating_details_for'] = 'Planificando: {name}';
$string['wizard_section_label'] = 'Seccion {section}: {name}';
$string['wizard_section_progress_with_total'] = '{done}/{total} actividades · {description}';
$string['wizard_section_progress_no_total'] = 'Actividades · {description}';
$string['wizard_activities_count'] = 'actividades';
$string['wizard_processing_status'] = 'Procesando...';
$string['wizard_error_stream_url'] = 'No se pudo obtener la URL de streaming.';
$string['wizard_error_connection'] = 'Error de conexion. Intenta de nuevo.';
$string['wizard_error_create_course'] = 'Error al crear el curso.';
$string['wizard_error_init_session'] = 'Error al inicializar sesión';
$string['wizard_error_upload_syllabus'] = 'Error al subir sílabo';
$string['wizard_error_send_feedback'] = 'Error al enviar feedback.';
$string['wizard_error_init_filepicker'] = 'No se pudo inicializar el selector de archivos.';
$string['wizard_error_generic'] = 'No se pudo generar el curso. Intenta de nuevo.';
$string['wizard_generate_starting'] = 'Iniciando...';
$string['wizard_generate_uploading_syllabus'] = 'Subiendo sílabo...';
$string['wizard_course_creating'] = 'Plan completado. Creando el curso en Moodle...';
$string['wizard_course_creating_subtitle'] = 'Generando contenido del curso...';
$string['wizard_completion_title'] = '¡Curso generado con éxito!';
$string['wizard_completion_summary_default'] = 'Tu curso ya está listo en Moodle.';
$string['wizard_completion_summary_no_images'] = 'Se crearon {activities} actividades en {units} secciones.';
$string['wizard_completion_summary_with_images'] = 'Se crearon {activities} actividades en {units} secciones y {images} imágenes.';
$string['wizard_completion_btn_open_course'] = 'Abrir curso en Moodle';
$string['wizard_completion_btn_create_another'] = 'Crear otro curso';
$string['wizard_back_to_context'] = 'Volver al contexto';
$string['wizard_live_note_detailed'] = 'Mostrando avance en tiempo real de la planificación detallada.';
$string['wizard_activity_default'] = 'Actividad';
$string['wizard_activity_quiz'] = 'Cuestionario';
$string['wizard_activity_book'] = 'Libro';
$string['wizard_activity_assign'] = 'Tarea';
$string['wizard_activity_forum'] = 'Foro';
$string['wizard_activity_lesson'] = 'Lección';
$string['wizard_activity_url'] = 'URL';
$string['wizard_activity_resource'] = 'Recurso';
$string['wizard_activity_page'] = 'Página';
$string['wizard_activity_data'] = 'Base de datos';
$string['wizard_activity_glossary'] = 'Glosario';
$string['wizard_plan_default_unnamed'] = '(sin nombre)';
$string['wizard_status_approving'] = 'Aprobando plan...';
$string['wizard_status_adjusting'] = 'Enviando ajuste...';
$string['wizard_chapters_label'] = 'capitulos';
$string['wizard_questions_label'] = 'preguntas';
$string['wizard_notes_label'] = 'notas';
$string['wizard_images_suggested_label'] = 'imagenes sugeridas';
$string['wizard_images_select_all'] = 'Seleccionar todas las imágenes';
$string['wizard_image_count_one'] = '{count} imagen';
$string['wizard_image_count_many'] = '{count} imagenes';
