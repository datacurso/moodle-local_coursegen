...
$string['setting_feature_toggles_heading'] = 'Control de funcionalidades';
$string['setting_feature_toggles_heading_desc'] = 'Active o desactive funcionalidades individuales del plugin. Estos ajustes actúan como interruptores maestros: cuando una funcionalidad está desactivada aquí, se oculta para todos los usuarios sin importar su rol o permisos.';
