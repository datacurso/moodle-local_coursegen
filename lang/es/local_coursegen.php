...
$string['help_part_maximages_help'] = 'Número máximo de imágenes que generará la IA para esta parte concreta de la actividad (entre 0 y 5). Si desactivas la parte, no se crearán imágenes para ella.';
